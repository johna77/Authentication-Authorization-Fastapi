...
if place:
    try:
        ...
        if option == "Sky":
            images = {'Rain': 'app/static/css/images/rain.png', 'Clouds': 'app/static/css/images/cloud.png', 'Clear': 'app/static/css/images/clear.png', 'Snow': 'app/static/css/images/snow.png'}
